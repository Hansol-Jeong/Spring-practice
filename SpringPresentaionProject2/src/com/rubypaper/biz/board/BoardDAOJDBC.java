...
public class BoardDAOJDBC implements BoardDAO {
	...
	// 글 등록
	/* (non-Javadoc)
	 * @see com.rubypaper.biz.board.BoardDAOInterface#insertBoard(com.rubypaper.biz.board.BoardVO)
	 */
	@Override
	...
	// 글 수정
	/* (non-Javadoc)
	 * @see com.rubypaper.biz.board.BoardDAOInterface#updateBoard(com.rubypaper.biz.board.BoardVO)
	 */
	@Override
	...
	// 글 삭제
	/* (non-Javadoc)
	 * @see com.rubypaper.biz.board.BoardDAOInterface#deleteBoard(com.rubypaper.biz.board.BoardVO)
	 */
	@Override
	...
	// 글 상세 조회
	/* (non-Javadoc)
	 * @see com.rubypaper.biz.board.BoardDAOInterface#getBoard(com.rubypaper.biz.board.BoardVO)
	 */
	@Override
	...
	// 글 목록 검색
	/* (non-Javadoc)
	 * @see com.rubypaper.biz.board.BoardDAOInterface#getBoardList(com.rubypaper.biz.board.BoardVO)
	 */
	@Override
