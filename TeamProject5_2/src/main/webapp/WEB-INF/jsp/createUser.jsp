...
<div id="menu">
	...
	<div class="menu-inner">
		...
		<ul>
			<li class="li"><a href="/blogsystem_search.do"><b>블로그 검색</b></a></li>
		</ul>
	</div>
...
<body class="blogcreate">

	<form action="/createdUser.do" method="get">
		<table width="100%" height=320 border="0" cellpadding="0"
			...
			<tr>
				<td width="100%" height="120" colspan="10" align="center"><img
					class="blogsystem_img" src="images/pascal.jpg" border="0"
					width="200" height="200"></td>
			</tr>
			<tr>
				<td height="80" colspan="10" align="center" class="posttitle">
					아이디 : <input type="text" name="userId" size="40">&nbsp;&nbsp;
				</td>
			</tr>
			<tr>
				<td height="80" colspan="10" align="center" class="posttitle">
					비밀번호 : <input type="password" name=userPassword size="40">&nbsp;&nbsp;
				</td>
			</tr>
			<tr>
				<td height="80" colspan="10" align="center" class="posttitle">
					닉네임 : <input type="text" name="name" size="40">&nbsp;&nbsp;
				</td>
			</tr>
			<tr>
