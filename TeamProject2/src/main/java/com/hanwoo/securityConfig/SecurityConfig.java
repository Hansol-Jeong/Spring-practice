...
//	private DataSource dataSource;
	...
	@Autowired
	private Blog_UserDetailsService userDetailsService;
	...
	protected void configure(HttpSecurity security) throws Exception {
		...
		security.authorizeRequests().antMatchers("/blogsystem_search").permitAll();
		security.authorizeRequests().antMatchers("/blogmain_detail").permitAll();
		...
		// 사용자에게 로그인 화면을 제공한다.
		security.formLogin().loginPage("/login").defaultSuccessUrl("/login.do", true);
